...
Разница между этими видами сервисов довольна размы и нет официальных правил о том, что можно называть файлообменников, а что облачным хранилищем.

По сути каждый файлообменник - это облачное хранилище, потому что файлы в любом случае загружаются и хранятся на удаленных серверах, т.е. в "облаке", но не каждое облачное хранилище является файлообменником, потому что есть облачные хранилища, которые не позволяют генерировать ссылки на файлы, чтобы их могли посмотреть или скачать по таким ссылкам.

На мой взгляд, разница между файлообменником и облачным сервисом заключается в том, что облачный сервис не ограничивает срок хранения загруженных в него файлов в период действия аккаунта, в хранилище которого загружены файлы, а также не ограничивает скорость скачивания собственных файлов из облачного хранилища.
...
Ссылки | Анонимная загрузка | Анонимная удаленная загрузка | Анонимная FTP загрузка | Анон срок хранения файла | Анон максимальный размер загружаемого файла | Анон паралленьное скачивание | Анон задержка/таймер перед скачиванием | Анон объем суточного скачивания | Анон ссылка на удаление файла | Анон нет ограничения на размер скачиваемого файла | Загрузка | Удаленная загрузка | Копирование | FTP загрузка | Срок хранения файла | Максимальный размер загружаемого файла | Паралленьное скачивание | Задержка/таймер перед скачиванием | Объем суточного скачивания | Нет ограничения на размер скачиваемого файла | Объем хранилища | Поиск по файлам | Статистика скачиваний | Количество оставшихся для хранения дней | Создание папок | Расшаривание папок | Скачать группу выделенных файлов | Продолжить скачивание после паузы | Установить пароль на ссылку | Установить количество скачиваний перед удалением | Возможность выцепить прямую ссылку | Прямая ссылка не привязана к IP | Возможность изменить расширение файла | Сервис не меняет имя файла | Есть Хэш MD5/SHA-256 | Есть Полное имя файла (с расширением) | Дата загрузки файла | Предпросмотр документов
--- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---
https://uploadrar.com/ | - | - | - | 1 | 0.00001 МБ | + | 12 сек | 30 ГБ ? | - | + | Multi | + | + | + ? | 30 | 6 ГБ | + | 8 сек | 40 ГБ | + | 608 ГБ | - | + | - | + | - | - | + | + | - | + | + | + | + | - | + | + | -
https://zippyshare.com | Multi | - | - | 30 | 500 МБ | + | - | unlim | - | + | Multi | + | - | + | 30 |500 МБ | + | - | unlim | + | unlim | только своим | + | + | + | + | - | + | - | - | - | - | + | + | - | +/- | + | картинки
